...
var App = new Vue({
    ...
    ready: function ready() {
        var tasks = this.$http.get('/tasks/all_json').then(function (response) {
...
},{"./components/tasks.js":24,"vue":22,"vue-resource":6,"vue-router":21}],24:[function(require,module,exports){
'use strict';
...
module.exports = {
    ...
    methods: {
        addTask: function addTask() {
            this.$http.post('/tasks/add-task', { task: this.$data.newTask }).then(function (response) {
                this.newTask = '';
                this.refreshBoard();
            });
        },
